...
using TiendaServicios.API.Mongo.Data;
...
namespace TiendaServicios.API.Mongo.Repositories
{
    public class ProductRepository : IProductRepository
    {
        ...
        {
            FilterDefinition<Product> filter = Builders<Product>.Filter.Eq(p => p.Categoria, categoryName);
        ...
        {
            FilterDefinition<Product> filter = Builders<Product>.Filter.ElemMatch(p => p.Nombre, name);
